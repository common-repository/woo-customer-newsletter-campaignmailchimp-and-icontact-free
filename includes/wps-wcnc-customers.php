		...
		?>
			<div class="wps-wcnc-actions">
				...
				<form name="wps-wcnc-cust-all-mc" id="wps-wcnc-cust-all-mc" method="POST">
					...
					<input id="wps-wcnc-cust-all-mc-btn" disabled class="button button-primary" name="submit" value="MailChimp" type="submit">
				</form> |
				<form name="wps-wcnc-cust-all-ic" id="wps-wcnc-cust-all-ic" method="POST">
					<input type="hidden" name="action" value="wps_wcnc_camp_all" />
					<input type="hidden" name="wps_wcnc_all_camp_name" value="icontact" />
					<input id="wps-wcnc-cust-all-ic-btn" disabled class="button button-primary" name="submit" value="IContact" type="submit">
				</form>
