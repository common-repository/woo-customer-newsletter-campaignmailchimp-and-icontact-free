...
Class WPS_WCNC_Admin{
							...
							<div class="container">
								<section class="ac-container">
									...
									<div>
										...
										<label for="ac-4">IContact</label>
										<?php $settings->display_settings_IContact(); ?>
									</div>
								</section>
								<?php 
									submit_button();
	...
	public static function register_settings_fields(){
	    ...
	    /* IContact */
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_icontact_status");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_icontact_username");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_iconatct_pass");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_iconatct_api_key");
	    register_setting("wps-wcnc-api-settings-section", "wps_wcnc_iconatct_list_id");
