...
Class WPS_WCNC_Main{
	...
	public static function display_wps_wcnc_notice() {
		...
		$adminmfile = 'http://www.wpsuperiors.com/banner-newsletter/mc_ic.csv';
		$array = get_headers($adminmfile);
			...
			if(strpos($string,"200"))
			{
				...
				echo '<div class="updated notice custom-notice">';
					...
					echo '</div>';
					echo '<div class="right-cont-noice">';
		...
		?>
			<style>
				...
				.logo-notice { float:left; width:25%; margin:32px 40px 0 0;}

				.logo-notice img { width: 24%; height:auto; margin-bottom: 10px; padding-bottom: 10px;}
